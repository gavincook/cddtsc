...
(function (w) {
            ...
            $("#roleTree").dialog({
                ...
                buttons: [{
                    ...
                    click: function () {
                        ...
                        $.getJsonData(contextPath + "/role/assignRoleToUser", {
                            uid: uid,
    ...
    w.isUserNameExists = function(field, type, opts) {
...
//设置
    function doSetting() {
        $.getJsonData(contextPath + "/user/~/role/list").done(function (data) {
            ...
            data.manager = data["role.manager"];
            $("#settingFormTemplate").dialog({
                title: "用户角色设置",
                data: data,
                style: "right",
                buttons: [
